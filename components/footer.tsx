...
<Image src={logo} alt="Velora Sports Logo" className="h-12 w-auto" />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/products/training" className="text-muted-foreground hover:text-foreground">
                  Training Gear
                </Link>
              </li>
              <li>
                <Link href="/products/equipment" className="text-muted-foreground hover:text-foreground">
                  Equipment
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t pt-8 mt-8 md:flex-row">
          <p className="text-xs text-black font-medium">
            © {new Date().getFullYear()} Velora Sports. All rights reserved.
          </p>
