...
import Link from "next/link"
import { useState } from "react"
import { Menu, Search, ShoppingCart, User, X, Package, XCircle, LogOut } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet"
import {
    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white shadow-sm">
        <div className="container flex h-16 items-center px-4">
          <Sheet>
            ...
            <SheetContent side="left" className="w-[300px] sm:w-[400px]">
              <nav className="flex flex-col gap-4 mt-8">
                ...
                <Link href="/products/men" className="text-lg font-medium">Men</Link>
                <Link href="/products/women" className="text-lg font-medium">Women</Link>
                <Link href="/products/training" className="text-lg font-medium">Training</Link>
                <Link href="/products/running" className="text-lg font-medium">Running</Link>
          ...
          <nav className="flex-1 hidden md:flex items-center justify-center gap-8 text-sm">
            <Link href="/" className="font-medium transition-colors hover:text-black">Home</Link>
            <Link href="/products" className="font-medium transition-colors hover:text-black">All Products</Link>
            <Link href="/products/men" className="font-medium transition-colors hover:text-black">Men</Link>
            <Link href="/products/women" className="font-medium transition-colors hover:text-black">Women</Link>
            <Link href="/products/training" className="font-medium transition-colors hover:text-black">Training</Link>
            <Link href="/products/running" className="font-medium transition-colors hover:text-black">Running</Link>
          </nav>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuItem asChild>
                  <Link href="/order-tracking" className="flex items-center cursor-pointer">
                    <Package className="mr-2 h-4 w-4" />
                    Track Order
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/refund-request" className="flex items-center cursor-pointer">
